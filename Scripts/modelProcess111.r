# =========================================================
# Like script 07processForPlot, but just for 111 cases 
# =========================================================
...
# Load fit16mp 
load(here('Data', 'ModelData', 'fit111.rda')) # 96 obs of 29
...
df<- df |> 
  mutate(trial_type = factor(trial_type, levels = c("A=0,B=1,E=1",
                                                   "A=1,B=0,E=1",
                                                   "A=1,B=1,E=1")),
...
# save
save(df, file=here('Data', 'ModelData', 'fitforplot111.rda')) 