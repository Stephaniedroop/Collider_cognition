---
title: "New minus old model predictions"
...
These are the fitted model predictions, for the same models on different data.
...
```{r, include=FALSE}
diff <- df[4:19]-dfold[4:19]
places1 <- df[1:3]
places2 <- df[20:27]

fordiffplot <- cbind(places1,diff,places2)

df <- fordiffplot
```

Plots of all models and all probability groups, for the new experiment data minus the old experiment data.
The models are the same series of 16 throughout, progressively lesioned.
A positive bar means the prediction was higher in the new experiment.
