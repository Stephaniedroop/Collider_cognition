...
# First set wd to curretn source

# ---------- Get main data -----------
# Setwd for main data
setwd("../Data/newexp") # as in, setwd("/Users/stephaniedroop/Documents/GitHub/Collider_cognition/Data/newexp")
...
# Also need data grouped by world and pgroup, then summarised by how many ppts said each answer
