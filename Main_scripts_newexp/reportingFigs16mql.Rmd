---
title: "Plots of model fit for all 16 models, for all 3 pgroups using the QL function"
output:
...
Takes model and data in csv `fitforplot16mQL.csv` calculated in `optimise_withKandEps.Rmd`. 
...
```{r, echo=FALSE}
df <- read.csv('../model_data/fitforplot16mql.csv') # 288 obs of 27 vars - only the actual values of A/B
```
