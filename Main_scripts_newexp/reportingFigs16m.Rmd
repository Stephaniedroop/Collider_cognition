---
title: "Plots of model fit for all 16 models, for all 3 pgroups, for Bramley+Droop CESM function"
output:
  html_document: default
  pdf_document: default
date: "2025-05-23"
params: 
  data_file: "../model_data/fitforplot16mpn.csv" # CHANGE INPUT DATA HERE ONLY 
---
...
## Some more specific plots, for reporting
...
Repeat just the observed v unobs for the full model just in case
...
I was thinking I should report noKind because its unobserved are more 'honest' since they are not stretched by the parameter kappa. But I should still do the full one afterwards.
