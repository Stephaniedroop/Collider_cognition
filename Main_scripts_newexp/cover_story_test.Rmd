...
```{r, echo=FALSE}
# This is pgroup 1
# ggplot(ansprops %>% filter(pgroup==1), 
#        aes(x = node3, y = n, fill = scenario)) +
#   geom_bar(stat = "identity", position = position_dodge()) +
#   labs(x = "Node answered", y = "Count of Answers", fill = "Cover story scenario") +
...
```{r, echo=FALSE}
# ggplot(ansprops %>% filter(pgroup==3), 
#        aes(x = node3, y = n, fill = scenario)) +
#   geom_bar(stat = "identity", position = position_dodge()) +
#   labs(x = "Node answered", y = "Count of Answers", fill = "Cover story scenario") +
#   facet_wrap(~trialtype) +
