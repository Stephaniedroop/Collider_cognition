...
- `13plotMatched.R` - TO DO, still in an unnumbered .rmd. Findings was it doesn't matter to do matched sampling

4. Free-standing analyses for reporting

- `coverTest.Rmd` - Freestanding analysis to check if cover story affects answers (it doesn't - except lightly in 2/36 conditions, which can be ascribed to noise)
